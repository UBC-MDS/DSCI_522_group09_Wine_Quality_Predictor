...
# eda
results/figure_1_class_imbalance.png results/figure_2_red_and_white_quantities.png results/figure_3_distribution_of_features.png results/table_1_combined_dataset.csv table_2_observations_count.csv table_3_summary.csv : src/eda.py data/processed/train_df.csv
...
# final report
# put html files here(build/html)
report : results/figure_1_class_imbalance.png results/figure_2_red_and_white_quantities.png results/figure_3_distribution_of_features.png results/table_1_combined_dataset.csv table_2_observations_count.csv table_3_summary.csv results/cross_val_results.csv results/feature_importances.csv results/random_forest_results.csv results/test_cm.png
