...
# final report
docs/wine_quality_predictor_report/_build/singlehtml/index.html : results/figure_1_class_imbalance.png results/figure_2_red_and_white_quantities.png results/figure_3_distribution_of_features.png results/figure_4_correlation_plot.png results/table_1_combined_dataset.csv results/table_2_observations_count.csv resutls/table_3_summary.csv results/cross_val_results.csv results/feature_importances.csv results/random_forest_results.csv results/test_cm.png
