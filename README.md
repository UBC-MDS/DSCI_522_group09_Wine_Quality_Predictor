...
```python
docker run --rm -it -v <FULL_LOCAL_PATH_TO_REPO>:/home/jovyan/ gfairbro/wine_quality_predictor make all
```
To reset the repo to a clean state, with no intermediate or results files, run the following command at the command line/terminal from the root directory of this project:
```python
docker run --rm -it -v <FULL_LOCAL_PATH_TO_REPO>:/home/jovyan/ gfairbro/wine_quality_predictor make clean
```
